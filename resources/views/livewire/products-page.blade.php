      ...
      <div class="flex flex-wrap mb-24 -mx-3">
        <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <ul>
              ...
              <li class="mb-4" wire:key="{{ $category->id }} >
                <label for=" {{ $category->slug }} " class="flex items-center dark:text-gray-400 ">
                  <input type="checkbox" wire:model.live="selected_categories" id=" {{ $category->slug }} " class="w-4 h-4 mr-2" value = " {{ $category->id }} ">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
            <div>
              <!--  cho phép người dùng chọn khoảng giá từ 2 triệu đến 99 triệu -->
              <div class="font-semibold"> {{ Number::currency($price_range, 'VND') }}</div>
              <input type="range" wire:model.live='price_range' class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="99000000" value="3000000" step="100000">
              <div class="flex justify-between ">
                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(3000000, 'VND') }}</span>
                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(99000000, 'VND') }}</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="border border-gray-300 dark:border-gray-700">
                ...
                <div class="p-3 ">
                  ...
                  <p class="text-lg ">
                    ...
                    Number::currency($product->price, 'VND')}}</span>
                  </p>
                </div>
