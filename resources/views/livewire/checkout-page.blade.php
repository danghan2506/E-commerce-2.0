			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<div class="mb-6">
					...
					<div class="mt-4">
						...
						<input wire:model='phone' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none  @error('phone') border-red-500 @enderror"  
						 id="phone" type="text">
						</input>
						@error('phone')
							<div class="text-red-500 text-sm">{{ $message }}</div>
					...
					<div class="grid grid-cols-2 gap-4 mt-4">
						<div>
							...
							<input wire:model='state' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none  @error('state') border-red-500 @enderror"
							 id="state" type="text">
							</input>
							@error('state')
							<div class="text-red-500 text-sm">{{ $message }}</div>
				...
				@error('payment_method')
					<div class="text-red-500 tex-sm"> {{ $message }} </div>
				@enderror 
			</div>
			<!-- End Card -->
		</div>
