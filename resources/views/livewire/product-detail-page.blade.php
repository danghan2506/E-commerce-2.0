          ...
          <div class="sticky top-0 z-50 overflow-hidden ">
            ...
            <div class="flex-wrap hidden md:flex ">
              ...
              <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{ url('storage', $image)}}'">
                <img src="{{ url('storage', $image)}}" alt=" {{ url('storage', $product->name)}}" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
              </div>
              @endforeach
          ...
          <div class="lg:pl-20">
            ...
            <div class="w-32 mb-8 ">
              ...
              <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                ...
                <input type="number" wire:model="quantity" readonly class="flex items-center w-full font-semibold text-center
                 text-gray-700 placeholder-gray-700 bg-gray-300 outline-none dark:text-gray-400 dark:placeholder-gray-400 dark:bg-gray-900 focus:outline-none text-md hover:text-black" placeholder="1">
            ...
            <div class="flex flex-wrap items-center gap-4">
              <button wire:click="addToCart({{ $product->id }})" class="w-full p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50
