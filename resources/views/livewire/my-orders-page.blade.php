        ...
        <div class="overflow-hidden">
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody>
              ...
              @endphp
              <!-- wire:key="{{ $order->id }}" là một cú pháp dùng trong Laravel Livewire để 
               gán một khóa duy nhất (unique key) cho một phần tử HTML trong thành phần Livewire. -->

              <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900
               dark:even:bg-slate-800" wire:key="{{ $order->id }}">
